...
const DeleteProducer = ({showModal, setShowModal, data, reload, setReload, setSubHeading}) => {
            ...
            <Modal show={showModal} onHide={handleClose} centered animation={false} backdrop="static">
                ...
                <Modal.Body>
                    ...
                    {response
                        ...
                        : <div>
                            <span style={{color: "red"}}>Are you sure you want to delete the following producer?</span>
